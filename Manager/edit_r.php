...
<!doctype html>
<html lang="en">
  <?php include("../Manager/mdcomponends/head.php"); ?> 

<body class="">
   <div class="wrapper">
    <?php include("../Manager/mdcomponends/sidebar.php"); ?> 
    <?php include("../Database/db_connection.php"); ?> 
      <div class="main-panel" style="height: 100vh;">
        <?php include("../Manager/mdcomponends/topnavbar.php"); ?> 
        <div class="container">
              ...
              <form action="function.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="bookingDuration" name="book_dur" required>
                    ...
                    <option value="Per Day" <?= $row['rate_type'] == 'Per Day' ? 'selected' : '' ?>>Per Day</option>
                    <option value="Per Week" <?= $row['rate_type'] == 'Per Week' ? 'selected' : '' ?>>Per Week</option>
                    <option value="Per Month" <?= $row['rate_type'] == 'Per Month' ? 'selected' : '' ?>>Per Month</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group pt-3 text-center">
                  ...
                  <button type="button" class="btn btn-warning btn-sm px-5" onclick="location.reload();">Reset</button>
